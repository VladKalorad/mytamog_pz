...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Location = System::Drawing::Point(72, 83);
			...
			this->button8->Click += gcnew System::EventHandler(this, &bird::button8_Click_1);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &bird::button7_Click_1);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &bird::button6_Click_1);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &bird::button5_Click);
			// 
			// progressBar4
			// 
			...
			this->progressBar1->Click += gcnew System::EventHandler(this, &bird::progressBar1_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(503, 30);
			...
			this->timer1->Interval = 7410;
			this->timer1->Tick += gcnew System::EventHandler(this, &bird::timer1_Tick);
			// 
			// timer2
			// 
			this->timer2->Enabled = true;
			this->timer2->Interval = 9800;
			this->timer2->Tick += gcnew System::EventHandler(this, &bird::timer2_Tick_1);
			// 
			// timer3
			// 
			this->timer3->Enabled = true;
			this->timer3->Interval = 4790;
			this->timer3->Tick += gcnew System::EventHandler(this, &bird::timer3_Tick_1);
			// 
			// button9
			// 
			...
			this->button9->Font = (gcnew System::Drawing::Font(L"UniSansSemiBoldItalic", 13.8F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button9->Location = System::Drawing::Point(308, 30);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(186, 51);
			this->button9->TabIndex = 54;
			this->button9->Text = L"Введите имя";
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &bird::button9_Click);
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 22.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox1->Location = System::Drawing::Point(69, 30);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(186, 49);
			this->textBox1->TabIndex = 53;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &bird::textBox1_TextChanged);
			// 
			// timer4
			// 
			this->timer4->Enabled = true;
			this->timer4->Interval = 2650;
			this->timer4->Tick += gcnew System::EventHandler(this, &bird::timer4_Tick);
			// 
			// menuStrip1
			// 
			...
			this->русскийToolStripMenuItem->Text = L"Русский";
			this->русскийToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::русскийToolStripMenuItem_Click);
			// 
			...
			this->английскийToolStripMenuItem->Text = L"Английский";
			this->английскийToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::английскийToolStripMenuItem_Click);
			// 
			...
			this->белорусскийToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::белорусскийToolStripMenuItem_Click);
			// 
			...
			this->белыйToolStripMenuItem->Text = L"Белый";
			this->белыйToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::белыйToolStripMenuItem_Click);
			// 
			...
			this->желтыйToolStripMenuItem->Text = L"Желтый";
			this->желтыйToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::желтыйToolStripMenuItem_Click);
			// 
			...
			this->красныйToolStripMenuItem->Text = L"Красный";
			this->красныйToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::красныйToolStripMenuItem_Click);
			// 
			...
			this->фиолетовыйToolStripMenuItem->Text = L"Фиолетовый";
			this->фиолетовыйToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::фиолетовыйToolStripMenuItem_Click);
			// 
			...
			this->выходToolStripMenuItem->Text = L"Выход";
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &bird::выходToolStripMenuItem_Click);
			// 
			// bird
			// 
